...
\end{equation}
This is not a linear system, therefore the solution must be computed with some iterative methods, (GN, steepest descent...) (cite also someone?)
