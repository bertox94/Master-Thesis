...
\begin{equation}
    ...
    \label{eq:4}
\end{equation}
Maximizing $\ell_m^i$ w.r.t to $\alpha$ is equal to minimize the second term in the above equation, since the first one is independent of $\alpha$ therefore \cite{MUNOZ200923} 
\begin{equation}
...
\end{equation}
In the cases $\sigma^2_i$ can be assumed constant $\sigma^2$, the equation simplifies as
\begin{equation}
