...
from \cite{10.5555/2161958} as an idea
\begin{itemize}
    \item Range free (whether or not it is in trasmission range) vs range based
    \item Centralized versus Distributed Methods
    \item Probabilistic versus Deterministic Methods
    \item Model-Based versus Fingerprinting Methods
\end{itemize}
\clearpage
...
\subsection{Maximum Likelihood with covariance weights (improved NLS with the covariance matrix)}
