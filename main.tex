...
\cite{rzk} found 4 main issue that causes RSSI instability: Multipath Fading (it is totally randomic \cite{10.5555/559977}, some attempts to mitigate this effect \cite{5208736}) and NLOS Propagation, Shadow Fading (showed spatial correlation \cite{244122,732812}), Systematic Bias or Error, Geometric Node Configuration (Geometric diluition of precision)
\section{Descrizione}
...
\begin{equation}
    \sigma^2_i=\frac{2}{m}\sum_{j=1}^m(\upsilon_i-\mu)^2
\end{equation}
