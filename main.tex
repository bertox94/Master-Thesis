...
\begin{equation}
    E\bigg[e^{-\frac{2}{\beta}\nu_i}\bigg]=E\bigg[d_i^2e^{-\frac{2}{\beta}\xi_i}\bigg]=d_i^2E\bigg[e^{-\frac{2}{\beta}\xi_i}\bigg]=d_i^2e^{\frac{2}{\beta^2}\sigma^2_i}
\end{equation}
\begin{equation}
    Var\bigg[e^{-\frac{2}{\beta}\nu_i}\bigg]=Var\bigg[d_i^2e^{-\frac{2}{\beta}\xi_i}\bigg]=d_i^4Var\bigg[e^{-\frac{2}{\beta}\xi_i}\bigg]=(e^{\frac{4}{\beta^2}\sigma^2}-1)e^{\frac{4}{\beta^2}\sigma^2}
\end{equation}
...
\end{split}    
\end{equation}
and by rearranging some factors
\begin{equation}
\begin{split}
