...
\end{align}
The improved cost function \cite{10.5555/2161958} takes the following form 
\begin{align}
...
\end{align}
The precision of this estimation can be further improved by imposing the constraint ?? ($\hat{\theta}_3=\hat{R}^2$) on the minimization. This condition is ignored if we use LLS, but it can be successfully employed with the method of Lagrange multipliers \cite{Lopez1994, pasa}.
